<template>
	<footer class="px-4 divide-y bg-blue-500  ">
   ...
   <span class="text-black  ml-2 text-xl lg:text-xl"> Skins.phone </span> 
      </div>
			</div>
            </div>
			<div class="grid grid-cols-2 text-sm   lg:w-2/3 sm:grid-cols-4">
				<div class="space-y-3">
				...
				<div class="space-y-3">
					<h3 class="  uppercase dark:text-gray-50">Company</h3>
					<ul class="space-y-1">
						<li>
							<a   href="#">Privacy</a>
						</li>
