...
<!-- header menu ----------------------------------------------------->
    ...
    <!--image header -------------------------------> 
 <div class=" bg-contain h-96 lg:bg-cover  w-full bg-fixed bg-no-repeat  " :style="{'background-image': `url(${headerImg})`  }" >
 <scroll-header-menu></scroll-header-menu> 
   
 </div>
  
<!-- Skins images and description for  GALAXY S22 ULTRA  -->
<div class=" text-gray-400 text-center lg:p-10   text-xl   mt-8      ">
<div>
    <span> Introducing GALAXY S22 ULTRA</span>
    <router-link to="/homePage/viewS22Ultra" class=" mt-5 mb-5 justify-end flex mr-2">View all</router-link>
   </div>   
 ...
 <!-- Skins images and description for  IPHONE 13 PRO  -->
  <div class="  text-gray-400 lg:p-10 lg:text-xl text-center mt-8  ">
   <div>
    ...
    <div class="mt-8 bg-orange-600 w-24  m-auto h-10 p-1 text-black  ">
